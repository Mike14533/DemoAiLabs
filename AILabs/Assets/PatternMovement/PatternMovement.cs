...
public class PatternMovement : MonoBehaviour {
	...
	void Start ()
    {
        ...
        pattern = new ControlData[] { pdr, pdr, pdr, pdr, pdr, pdr, pdr, pdr, pdr, pdr,
            ...
            pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,
            pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,
            pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,
            pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,pdu,
            pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,
            pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,
            pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,
            pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,pdd,
